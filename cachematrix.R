...
#been calculated. If the inverse has already been calculated, it gets the inverse 
#from the cache and skips the computation. If the inverse has not already been calculated, 
